...
var changeUserAddress = function() {
  var newUserAddress = prompt("What is your new address?");
  document.getElementById("userAddress").innerHTML=newUserAddress;
...
var changeAccountNumber = function() {
 var newAccountNumber = prompt("What would you like your account number to be?");
...
var newAccountOpenDate = prompt("When did you open the account?");
...
var depositAmmount = prompt("How much would you like to deposit?");
var currentBalance = document.getElementById("balance").innerHTML;
var newAccountBalance = parseFloat(depositAmmount) + parseFloat(currentBalance)

document.getElementById("balance").innerHTML=newAccountBalance.toFixed(2);
...
var withdrawAmmount = parseFloat (prompt("How much would you like to withdraw?")) ;

var currentBalance = parseFloat ( document.getElementById("balance").innerHTML ) ;
var withdrawAccountBalance = currentBalance - withdrawAmmount;

document.getElementById("balance").innerHTML=withdrawAccountBalance.toFixed(2);
}
...
var currentBalance = parseFloat ( document.getElementById("balance").innerHTML ) ;
var interestRate = (.03); 
var newDayBalance = currentBalance * (1+interestRate);

document.getElementById("balance").innerHTML=newDayBalance.toFixed(2);
...
var currentBalance = parseFloat ( document.getElementById("balance").innerHTML ) ;
var taxRate = (.03); 
var newDayBalance = currentBalance * (1-taxRate);
